        ...
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 lg:grid-cols-5">
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="max-w-md text-gray-600">
              A software studio focused on fast, reliable digital products. We partner with business teams to turn ideas into
              full user experiences with clear timelines.
            </p>
            <div className="flex flex-wrap gap-3 text-sm text-gray-500">
              <span className="rounded-full bg-indigo-50 px-3 py-1 text-indigo-700">Tech consulting</span>
              ...
              <span className="rounded-full bg-indigo-50 px-3 py-1 text-indigo-700">System integration</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col">
              ...
              <p className="py-2 text-gray-600">Stockholm · Riyadh · Dubai</p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="mt-4 text-sm text-gray-500">We respond within two business days.</p>
          </div>
        </div>

        <div className="my-8 text-sm text-center text-gray-500">
          © {new Date().getFullYear()} Nova Code. All rights reserved.
        </div>
      </Container>
    </div>
  );
