      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            At Nova Code, we specialize in crafting high-quality 
            websites and applications tailored to your business needs. 
            Our innovative solutions and expert team ensure that your digital presence stands out and drives results.
            </p>
